...
function SortableItem({ item }: { item: Location }) {
    ...
    return (
        <div
            ...
            className="p-4 border rounded-md flex justify-between items-center hover:shadow transition-all"
        >
            <div>
                <h4 className="font-medium text-gray-800">{item.locationName}</h4>
            </div>
