    ...
    <nav className="bg-white shadow-md py-4 border-b border-gray-200">
        ...
        <div className="container mx-auto flex justify-between items-center px-6 lg:px-8">
            <Link href={"/"}  className="flex items-center">
                ...
                <span className="text-2xl font-bold text-gray-800">{" "} Travel buddy</span>
            </Link>
            ...
            <div className="flex items-center space-x-4">
                {session ? (
                 <> 
                  ...
                  <button className="flex items-center justify-center bg-gray-800 hover:bg-gray-900 text-white p-2 rounded-sm cursor-pointer" onClick={logout}>Sign out  
                 </button>
                  </>
                ):(
                  <button className="flex items-center justify-center bg-gray-800 hover:bg-gray-900 text-white p-2 rounded-sm cursor-pointer" onClick={login}>Sign in 
                   <svg
